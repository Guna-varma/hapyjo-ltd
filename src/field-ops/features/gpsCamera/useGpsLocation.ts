/**
 * Web port: identical hook surface, permission flow, 15s timeout race and error
 * handling as the mobile hook. expo-location -> browser geolocation via lib/location.
 */
