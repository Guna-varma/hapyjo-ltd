...
/**
 * Global busy indicator: animated dump truck. Markup + motion live in field-ops.css
 * (.fo-truck-loader). No caption — the motion alone signals that work is in progress.
 */
export function TruckLoader() {
  return (
    <div className="fo-truck-loader" aria-hidden="true">
      <div className="fo-truck-wrapper">
        <div className="fo-truck-body">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 198 93" className="fo-truck-svg">
            <path
              strokeWidth="3"
              stroke="#282828"
              fill="#F83D3D"
        ...
        <div className="fo-truck-tires">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" className="fo-tire-svg">
        ...
        <div className="fo-truck-road" />
        <svg
          viewBox="0 0 453.459 453.459"
          xmlns="http://www.w3.org/2000/svg"
          fill="#000000"
          className="fo-truck-lamp"
        >
