...
/**
 * Home Header – same content as the home page hero:
 * background video/image, headline, description, CTAs, and stats card.
 */
const HomeHeader = () => {
  ...
  return (
    <header className="relative min-h-[90vh] overflow-hidden bg-[hsl(var(--navy))]" aria-label="Home header">
